        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Have questions about our research or want to collaborate? Reach out to the founder directly.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left transition-transform hover:-translate-y-1 duration-300">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-xl text-slate-900 mb-1">Email Us</span>
                <a href="mailto:admin@gmail.com" className="text-lg text-gray-600 hover:text-[#e3b632] transition-colors font-medium">
                  admin@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left transition-transform hover:-translate-y-1 duration-300">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-xl text-slate-900 mb-1">Call Us</span>
                <a href="tel:+998901234567" className="text-lg text-gray-600 hover:text-[#e3b632] transition-colors font-medium">
                  +998 90 123 45 67
                </a>
              </div>
            </div>
